...
import com.bixian365.dzc.utils.zxing.view.ViewfinderResultPointCallback;
...
public final class CaptureActivityHandler extends Handler {
	...
	public CaptureActivityHandler(BaseQRScanActivity activity, Vector<BarcodeFormat> decodeFormats, String characterSet) {
	...
	public void handleMessage(Message message) {
		switch (message.what) {
		case R.id.auto_focus:  // 聚焦之后会自动发送一个消息
