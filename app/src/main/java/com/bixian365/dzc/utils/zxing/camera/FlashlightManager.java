...
package com.bixian365.dzc.utils.zxing.camera;
...
final class FlashlightManager {
    ...
    private static Class<?> maybeForName(String name) {
        try {
            ...
            Log.w(TAG, "Unexpected error while finding class " + name, cnfe);
            // OK
            return null;
    ...
    static void enableFlashlight(Camera camera) {
        setFlashlight2(camera, true);
    }

    static void disableFlashlight(Camera camera) {
        setFlashlight2(camera, false);
    }
...
//    static Camera.Parameters parameters;
    ...
    private static void setFlashlight2(Camera camera, boolean active) {
        Log.d(TAG ,"setFlashLight2:" + active + " camera:" + camera);
