 ...
 * contents of a view via a vertical swipe gesture. The com.hundsun.cqsxbank.mobilepay.activity that
 ...
 * indication of a refresh. If an com.hundsun.cqsxbank.mobilepay.activity wishes to show just the progress
...
//        ViewCompat.setHasTransientState(view, hasTransientState);
...
//    }
    ...
    private void startScaleDownReturnToStartAnimation(int from,
        ...
        if (isAlphaUsedForScale()) {
            ...
            mStartingScale = ViewCompat.getTranslationX(mCircleView);
        }
