...
//				height = MAX_FRAME_HEIGHT;
	...
	public Rect getFramingRectInPreview() {
		if (framingRectInPreview == null) {
			...
			Log.e(TAG, "screem size:" + screenResolution);
			Log.e(TAG, "camera size:" + cameraResolution);
			...
			Log.d(TAG, "Calculated framing in preview rect: " + framingRectInPreview);
		}
	...
	public PlanarYUVLuminanceSource buildLuminanceSourceWithOrgSize(byte[] data, int width, int height) {
		int previewFormat = configManager.getPreviewFormat();
		String previewFormatString = configManager.getPreviewFormatString();
		switch (previewFormat) {
		// This is the standard Android format which all devices are REQUIRED to
