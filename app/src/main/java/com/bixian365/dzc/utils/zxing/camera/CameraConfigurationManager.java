...
final class CameraConfigurationManager {
	...
	void initFromCameraParameters(Camera camera) {
		...
		screenResolution = new Point(display.getWidth(), display.getHeight() - DisplayUtils.getActualSize(context, 60));
	 ...
	 * 获取当前摄像头的视频流格式
	 * 可能的值有：
	 * YCbCr 4:2:0、YCbCr 4:2:2、YCbCr 4:1:1和 YCbCr 4:4:4
	 * 
	 * @return
	 */
	...
	/**
	 * 摄像头支持的分辨率列表和屏幕分辨率获取一个最合适的分辨率
	 * @param previewSizeValueString 摄像头支持的所有分辨率列表
