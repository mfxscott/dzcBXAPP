...
//            shopPrice = (TextView) view.findViewById(R.id.type_info_shop_price_tv);
    ...
    public BillItemRecyclerViewAdapter(Context context,String unit,List<BillChirdrenEntity> category) {
    ...
    public BillItemRecyclerViewAdapter(Context context,String unit,List<BillChirdrenEntity> category,View view) {
        context.getTheme().resolveAttribute(R.attr.selectableItemBackground, mTypedValue, true);
        mBackground = mTypedValue.resourceId;
        this.context = context;
        goodsUnit = unit;
